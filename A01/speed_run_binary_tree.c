...
static void solution_2_treesearch(int move_number, int position, int speed, int final_position)
{
...
static void solve_2(int final_position)
{
  ...
  solution_1_best.n_moves = final_position + 100;
  solution_2_treesearch(0,0,0,final_position);
  solution_2_elapsed_time = cpu_time() - solution_1_elapsed_time;
}
